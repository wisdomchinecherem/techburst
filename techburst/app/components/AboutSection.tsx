      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/60 sm:text-lg">
            [Placeholder] TECH-BURST is Africa&rsquo;s ecosystem activation
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/60">
            ...
            geographic footprint, or what makes your execution model
            different from a typical agency.
          </p>
        </div>
        <ImagePlaceholder label="Team photo / office / event photo" aspect="portrait" />
      </div>
    </section>
  );
}
